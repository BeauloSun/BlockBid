    ...
    <section class="bg-[#0f103e] min-h-screen flex items-center justify-center">
      <div class="bg-[#724fff] flex rounded-2xl shadow-lg max-w-[1100px] p-5 items-center">
        <div class="md:w-1/2 px-6 md:px-10">
          <img alt="" class="rounded-2xl" src={nft1} />
        </div>
        <div class="md:w-1/2 px-6 md:px-10">
          <h2 class="font-bold text-8xl text-[#ffffff] font-shadows">NFT 1</h2>
          <p class="text-3xl mt-4 pt-4 text-[#ffffff]">Current Price: $100</p>
          <p class="text-3xl mt-4 pt-4 text-[#ffffff]">Time Left: 10 minutes</p>
